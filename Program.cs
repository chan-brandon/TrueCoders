...
namespace TrueCoders
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            astralis.Colors = "Red and White";
            astralis.Location = "Denmark";
            ...
            Gamers simple = new Gamers("s1mple", 510, "NaVi", 1, "CIS", "Yellow and Black");
            Gamers fallen = new Gamers("Fallen", 957, "MiBR", 6, "North America/Brazil", "Blue and Silver");
            Gamers device = new Gamers("dev1ce", 1500, "Astralis", 3, "Denmark", "Red and White");
            Gamers zywoo = new Gamers("ZywOo", 157, "Vitality", 2, "France", "Yellow and Black");
            Gamers coldzera = new Gamers("coldzera", 924, "FaZe Clan", 4, "EU", "Red and Black");
            Gamers niko = new Gamers("NiKo", 657, "FaZe Clan", 5, "EU", "Red and Black");
            ...
            {
            Console.WriteLine($"The {player.Game} player {player.Name} is the #{player.Rank} player " +
            $"in the world that plays for the {player.Colors} team {player.TeamName} " +
            $"from {player.Location} and has earned ${player.Winnings}k in his career.");
            ...
            $"We would like to announce that we have secured the services of duos {casterList[0].CasterName} +" +
            $" {casterList[1].CasterName}, {casterList[2].CasterName} + {casterList[3].CasterName}, " +
            $"and {casterList[5].CasterName} + {casterList[4].CasterName}! " +
